...
jQuery("button.slick-prev.slick-arrow").text(function () {
    return jQuery(this).text().replace("Previous", "<"); 
});
jQuery("button.slick-next.slick-arrow").text(function () {
    return jQuery(this).text().replace("Next", ">"); 
});

jQuery(document).on('change','#reason-list',function(){
jQuery('.Service').hide();
var attrs = jQuery(this).val();
jQuery('#'+attrs).show();
});


jQuery(document).on('change','#reason-listtwo',function(){
jQuery('.Showrooms').hide();
var attrs = jQuery(this).val();
jQuery('#'+attrs).show();
});
