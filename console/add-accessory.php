...
<?php
$result = $admin->get_single_result('hy_accessories_cars','id',$_GET['id'],'accessorieslist?id='.$_GET['id']);
?>
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add <?php echo $result['car_name'];?> Accessory</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
		   <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add <?php echo $result['car_name'];?> Accessory</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="process" method="POST" enctype="multipart/form-data">
			  <input type="hidden" name="action" value="AddAccessories">
			 <input type="hidden" name="car_id" value="<?php echo $result['id']; ?>">
			  <input type="hidden" name="page" value="add-accessory?id=<?php echo $result['id']; ?>">
                <div class="card-body">
	...
	unset($_SESSION['success']);
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="price" placeholder="Enter Price" id="price" value="">
                  </div>
                 <div class="form-group">
